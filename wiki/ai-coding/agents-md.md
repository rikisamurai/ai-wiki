...
> [!tip] "犯错两次就 retrospective"是 Codex 的 [[wiki/ai-coding/两次纠正规则|两次纠正规则]]
> Codex 官方建议：**当 Codex 在同一处犯第二次错时，让它做 Retrospective 并更新 AGENTS.md**。这与 Claude Code 的 [[wiki/ai-coding/两次纠正规则|两次纠正规则]] 是同一思路——把"反复纠正"提升为"持久化指令"。两次是阈值；一次是巧合，三次是失职。
