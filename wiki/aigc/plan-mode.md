...
> [!tip] 与 [[wiki/aigc/permission-modes|权限模式]] 的关系
> Plan Mode 本身就是 YOLO/Safe/Plan 三档权限里的一档——核心机制是"工具白名单收紧到只读"。Safe Mode 是逐次确认每个工具调用，Plan Mode 是直接禁掉一类工具，思路不同但都是降低 [[wiki/ai-coding/plausible-code|似是而非代码]] 的产生。
