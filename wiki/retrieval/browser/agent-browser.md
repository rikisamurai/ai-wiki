...
>
> 这是它在 [[wiki/agent-engineering/context/context-window|上下文]]经济学上的杀手锏——把无关节点全过滤掉，只留可交互元素 + 稳定 ID。
...
> | **Content Boundary Markers** | `--content-boundaries` 用随机 nonce 包裹页面内容，防 [[wiki/claude-code/fail-closed-tool-defaults\|Prompt Injection]] |
