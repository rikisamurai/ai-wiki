...
> | | Skill | Slash Command | [[wiki/agent-engineering/workflow/subagent-上下文隔离\|Subagent]] |
> | --- | --- | --- | --- |
...
> [!tip] 跨 Agent 复用
> 同一份 skill 仓库（如 [[wiki/obsidian/obsidian-skills|obsidian-skills]]）能服务多种 Agent —— Claude Code 装到 `.claude/skills/`，Codex CLI 装到 `~/.codex/skills`，[[wiki/obsidian/claudian|Claudian]] 装到 `{vault}/.claude/skills/`。这是 [[wiki/claude-code/mcp|MCP]] 之外另一条"标准化 Agent 生态"的路径。
