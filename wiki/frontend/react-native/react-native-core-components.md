...
- 推荐：用 [[wiki/frontend/react-native/flash-list|FlashList]] 替代二者，[[wiki/frontend/react-native/view-recycling|View 回收]] 机制更不易白屏
...
详见 [[wiki/frontend/react-native/pressable-vs-touchable|Pressable vs TouchableOpacity]]。
