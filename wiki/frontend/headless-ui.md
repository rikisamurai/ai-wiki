...
商业组件库（[[wiki/frontend/per-seat-licensing|AG Grid 一类]]）面临的不是增长放缓，而是 AI 代码生成把"配置一个商业组件"和"让 AI 写一个 headless 替代"的成本曲线翻了过来。Tailwind Labs 2026 年 1 月裁员 75% 是这个趋势的注脚之一——即使是 State of JS 2025 最受欢迎的 CSS 框架，也躲不过商业模式的天花板。
