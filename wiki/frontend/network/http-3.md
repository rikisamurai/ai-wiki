...
HTTP/3 是基于 [[wiki/frontend/network/quic|QUIC]] 协议的下一代 HTTP 标准，把传输层从 TCP 换成 UDP，从根本上解决了 HTTP/2 的 [[wiki/frontend/network/head-of-line-blocking|队头阻塞]] 问题，同时带来更快的握手和 [[wiki/frontend/network/connection-migration|连接迁移]] 能力。

> [!compare] HTTP/2 vs HTTP/3
> | 维度 | HTTP/2 | HTTP/3 |
> | --- | --- | --- |
> | 传输层 | TCP | QUIC（基于 UDP） |
> | 握手延迟 | 2-3 RTT | 1 RTT 首次 / [[wiki/frontend/network/0-rtt-握手\|0-RTT]] 重连 |
