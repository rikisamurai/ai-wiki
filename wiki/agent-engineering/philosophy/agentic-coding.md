...
> [!note] 三大边界
> 1. 训练语料里的代码大量是低质量浆糊（"big ball of mud"），导致 AI 倾向于喷射 [[wiki/agent-engineering/philosophy/plausible-code|似是而非的代码]]
> 2. 软件质量缺乏可量化的回归指标（不像围棋有终局胜负），AI 难以自我提升核心设计能力
> 3. 真正的瓶颈是 [[wiki/agent-engineering/code-review/review-带宽瓶颈|Review 带宽]]，不是生成带宽
...
避免：
- [[wiki/agent-engineering/philosophy/yagni-与-dry-反论|过度 DRY 抽象]]
- 教条式 TDD / 盲目追覆盖率

倾向：
- 用代码表达 spec（人写 harness，AI 学风格扩展）
- [[wiki/agent-engineering/context/隐性知识与上下文|主动提供隐性知识]]
...
## 与 [[wiki/agent-engineering/philosophy/worse-is-better|Worse is Better]] 的关系
