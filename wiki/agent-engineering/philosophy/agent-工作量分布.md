...
| 系统调用 | 53+ 工具 |
| 用户权限管理 | 权限四态系统 |
| 应用商店 | [[wiki/skills/agent-skills\|Skills]] |
| 设备驱动 | [[wiki/claude-code/mcp\|MCP]] |
| 进程管理 | [[wiki/agent-engineering/workflow/coordinator-模式\|Agent 蜂群]] |
| 内存管理 | [[wiki/agent-engineering/context/compact-vs-clear\|上下文压缩]] |
| 文件系统 | Transcript 持久化 |
