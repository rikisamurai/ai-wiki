...
source: "https://x.com/yhslgg/status/2068317116831510838"
author:
  - "[[@yhslgg]]"
published: 2026-06-20
created: 2026-06-23
description: "最近连续分享了好几个 OSINT 工具，今天就给兄弟们讲讲怎么组合用。今天一次说清楚——五个工具，覆盖你能想到的几乎所有查人、查公司、查设备场景，直接开盒任何人，本文只讲思路和介绍工具及YY使用场景；不提倡实际应用。这套东西不提倡查别人，希望大家用来保护自己。先说五个工具各干什么..."
tags:
  - "clippings"
ingested-at: 2026-06-23
---
![Image](https://pbs.twimg.com/media/HLQg0ruaQAA-KEl?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQg5YlbgAAyJpw?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQhI94bcAAUq5G?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQhKGGb0AAcm-5?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQhK3nbAAAuVMq?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQhL11aAAENUDE?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HLQhMaLaYAAyY14?format=jpg&name=large)

> 拿到用户名 → Blackbird（快速全貌）→ Maigret（递归深挖） 拿到邮箱 → Blackbird（账号+AI画像）→ SpiderFoot（泄露+暗网） 拿到域名 → theHarvester（邮箱/子域名批量采集）→ SpiderFoot（深挖） 拿到 IP → Shodan（设备和服务暴露情况）→ SpiderFoot（关联情报） 什么都有 → 全部上，交叉验证

原则只有一条：**先用最快的出全貌，再用最深的往下挖。**

## 安装，一人一行命令

> \# Blackbird git clone [https://github.com/p1ngul1n0/blackbird](https://github.com/p1ngul1n0/blackbird) && pip install -r requirements.txt # Maigret pip install maigret # SpiderFoot git clone [https://github.com/smicallef/spiderfoot](https://github.com/smicallef/spiderfoot) && pip install -r requirements.txt # theHarvester git clone [https://github.com/laramies/theHarvester](https://github.com/laramies/theHarvester) && uv sync # Shodan Python pip install shodan
...
- [github.com/p1ngul1n0/blackbird](https://github.com/p1ngul1n0/blackbird)
- [github.com/soxoj/maigret](https://github.com/soxoj/maigret)
- [github.com/smicallef/spiderfoot](https://github.com/smicallef/spiderfoot)
- [github.com/laramies/theHarvester](https://github.com/laramies/theHarvester)
- [github.com/achillean/shodan-python](https://github.com/achillean/shodan-python)

好东西转给需要的兄弟。🚀

[#OSINT](https://x.com/search?q=%23OSINT&src=hashtag_click) [#开源工具](https://x.com/search?q=%23%E5%BC%80%E6%BA%90%E5%B7%A5%E5%85%B7&src=hashtag_click) [#老杨啊分享](https://x.com/search?q=%23%E8%80%81%E6%9D%A8%E5%95%8A%E5%88%86%E4%BA%AB&src=hashtag_click)