...
可以在 block 后面添加 ^ ，这样就是一个 block id，然后可以任意引用

| [[block-link-demo#^37066d]] | [[block-link-demo#^37066f]] |
| --------------------------- | --------------------------- |
| [[block-link-demo#^063f9a]] | [[block-link-demo#^37006f]] |
...
This is the tale of Gemmy, the Unhelpful assistant.   ^063f9a
